...
const seoTextContent = `
  Vítejte na naší stránce zaměřené na <strong>náhradní díly pro automobily Mercedes GLB třídy</strong>. 
  ...
  Objevte naši nabídku a vyberte si z našich produktů, které jsou ideální pro všechny modely Mercedes GLB třídy.
`;
  ...
  return (
    <>
     <Head>
        ...
        <title>Auto Dily Express | Náhradní díly pro Mercedes GLB třídy</title>
        <meta
          name="description"
        ...
        <link rel="cannonical" href="https://autodilyexpress.cz/GLB-Trida" />
      ...
      <Center>
      <h1>Náhradní díly pro model Mercedes GLB-Třída</h1>
