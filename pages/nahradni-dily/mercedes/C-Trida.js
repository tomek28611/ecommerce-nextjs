...
const seoTextContent = `
  Vítejte na naší stránce zaměřené na <strong>náhradní díly pro automobily Mercedes C třídy</strong>. 
  ...
  Objevte naši nabídku a vyberte si z našich produktů, které jsou ideální pro všechny modely Mercedes C třídy.
`;
  ...
  return (
    <>
      <Head>
        ...
        <title>Auto Dily Express | Náhradní díly pro Mercedes C třídy</title>
        <meta
          name="description"
        ...
        <link rel="cannonical" href="https://autodilyexpress.cz/C-Trida" />
      ...
      <Header />
      <Center>
      <h1>Náhradní díly pro model Mercedes C-Třída</h1>
...
export async function getServerSideProps() {
  ...
  const modelNumbers = ["204", "205", "206"];
