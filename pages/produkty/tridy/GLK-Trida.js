...
const seoTextContent = `
  Vítejte na naší stránce zaměřené na <strong>náhradní díly pro automobily Mercedes GLK třídy</strong>. 
  ...
  Objevte naši nabídku a vyberte si z našich produktů, které jsou ideální pro všechny modely Mercedes GLK třídy.
`;
  ...
  return (
    <>
     <Head>
        ...
        <title>Auto Dily Express | Náhradní díly pro Mercedes GLK třídy</title>
        <meta
          name="description"
      ...
      <Header />
      <Center>
      <h1>Náhradní díly pro model Mercedes GLK-Třída</h1>
        <SEOText>
