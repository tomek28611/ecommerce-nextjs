...
const seoTextContent = `
  Vítejte na naší stránce zaměřené na <strong>náhradní díly pro automobily Mercedes G třídy</strong>. 
  ...
  Objevte naši nabídku a vyberte si z našich produktů, které jsou ideální pro všechny modely Mercedes G třídy.
`;
...
export default function ProductsPage({ products }) {
  return (
    <>
        ...
        <title>Auto Dily Express | Náhradní díly pro Mercedes G třídy</title>
        <meta
          name="description"
        ...
        <link rel="cannonical" href="https://autodilyexpress.cz/G-Trida" />
...
export async function getServerSideProps() {
  ...
  const filteredProducts = allProducts.filter(product =>
    product.title.toLowerCase().includes("463")
  );
