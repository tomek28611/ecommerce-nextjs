...
const seoTextContent = `
  Vítejte na naší stránce zaměřené na <strong>náhradní díly pro automobily Mercedes CLA třídy</strong>. 
  ...
  Objevte naši nabídku a vyberte si z našich produktů, které jsou ideální pro všechny modely Mercedes CLA třídy.
`;
  ...
  return (
    <>
     <Head>
        ...
        <title>Auto Dily Express | Náhradní díly pro Mercedes CLA třídy</title>
        <meta
          name="description"
        ...
        <link rel="cannonical" href="https://autodilyexpress.cz/CLA-Trida" />
      ...
      <Center>
      <h1>Náhradní díly pro model Mercedes CLA-Třída</h1>
        <SEOText>
