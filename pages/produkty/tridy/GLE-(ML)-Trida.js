...
const seoTextContent = `
  Vítejte na naší stránce zaměřené na <strong>náhradní díly pro automobily Mercedes GLE třídy</strong>. 
  ...
  Objevte naši nabídku a vyberte si z našich produktů, které jsou ideální pro všechny modely Mercedes GLE třídy.
`;
  ...
  return (
    <>
      <Head>
        ...
        <title>Auto Dily Express | Náhradní díly pro Mercedes GLE třídy</title>
        <meta
          name="description"
        ...
        <link rel="cannonical" href="https://autodilyexpress.cz/GLE-Trida" />
      ...
      <Header />
      <Center>
      <h1>Náhradní díly pro model Mercedes GLE-Třída</h1>
        <SEOText>
