...
const seoTextContent = `
  Vítejte na naší stránce zaměřené na <strong>náhradní díly pro automobily Mercedes GLA třídy</strong>. 
  ...
  Objevte naši nabídku a vyberte si z našich produktů, které jsou ideální pro všechny modely Mercedes GLA třídy.
`;
  ...
  return (
    <>
      <Head>
        ...
        <title>Auto Dily Express | Náhradní díly pro Mercedes GLA třídy</title>
        <meta
          name="description"
        ...
        <link rel="cannonical" href="https://autodilyexpress.cz/GLA-Trida" />
