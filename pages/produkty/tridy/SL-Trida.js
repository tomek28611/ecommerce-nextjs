  ...
  return (
    <>
      <Head>
        ...
        <title>Auto Dily Express | Náhradní díly pro Mercedes SL třídy</title>
        <meta
          name="description"
        ...
        <link rel="cannonical" href="https://autodilyexpress.cz/SL-Trida" />
      ...
      <Header />
      <Center>
        <Title>Díly pro model SL-Třída</Title>
        {products.length === 0 ? (
          <NoProductsContainer>
