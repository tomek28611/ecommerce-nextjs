...
const seoTextContent = `
  Vítejte na naší stránce zaměřené na <strong>náhradní díly pro automobily Mercedes B třídy</strong>. 
  ...
  Objevte naši nabídku a vyberte si z našich produktů, které jsou ideální pro všechny modely Mercedes B třídy.
`;
...
export default function ProductsPage({ products }) {
  return (
    ...
    <Head>
        ...
        <title>Auto Dily Express | Náhradní díly pro Mercedes B třídy</title>
        <meta
          name="description"
        ...
        <link rel="cannonical" href="https://autodilyexpress.cz/B-Trida" />
      ...
      <Center>
      <h1>Náhradní díly pro model Mercedes B-Třída</h1>
        <SEOText>
