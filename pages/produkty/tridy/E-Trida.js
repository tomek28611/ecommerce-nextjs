...
const seoTextContent = `
  Vítejte na naší stránce zaměřené na <strong>náhradní díly pro automobily Mercedes E třídy</strong>. 
  ...
  Objevte naši nabídku a vyberte si z našich produktů, které jsou ideální pro všechny modely Mercedes E třídy.
`;
  ...
  return (
    <>
     <Head>
        ...
        <link rel="cannonical" href="https://autodilyexpress.cz/E-Trida" />
