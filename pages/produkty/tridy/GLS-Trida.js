...
const seoTextContent = `
  Vítejte na naší stránce zaměřené na <strong>náhradní díly pro automobily Mercedes GLS třídy</strong>. 
  ...
  Objevte naši nabídku a vyberte si z našich produktů, které jsou ideální pro všechny modely Mercedes GLS třídy.
`;
export default function ProductsPage({ products }) {
  return (
    ...
    <Head>
        ...
        <title>Auto Dily Express | Náhradní díly pro Mercedes GLS třídy</title>
        <meta
          name="description"
        ...
        <link rel="cannonical" href="https://autodilyexpress.cz/GLS-Trida" />
        ...
        <meta name="twitter:description" content="Nabízíme motorové díly, prvky karoserie, elektrické součástky a další. Rychlá dodávka"></meta>
         ...
         <Header />
      <Center>
      <h1>Náhradní díly pro model Mercedes GLS-Třída</h1>
        <SEOText>
